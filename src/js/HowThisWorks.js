...
const HowThisWorks = (props) =>{
    ...
    \n\n## You're in beta. What are you testing?
    \n\nPretty much everything. The invite process, the writing experience, the clarity for people both in and out of the CMV community. If you have any feedback on anything, you can send it to [/u/wattinviterunner](https://www.reddit.com/message/compose/?to=wattinviterunner) or [@projectwatt](http://twitter.com/projectwatt) on Twitter. 
